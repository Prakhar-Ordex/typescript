...
const Product = () => {
    ...
    (0, react_1.useEffect)(() => {
        dispatch((0, ProductSlice_1.fetchProducts)(null));
    }, []);
      ...
      <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-2 min-h-screen">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            ? dispatch((0, ProductSlice_1.fetchProducts)(e.target.value))
            : dispatch((0, ProductSlice_1.fetchProducts)(null))} data-modal-toggle="filterModal" data-modal-target="filterModal" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
          ...
          <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
            {state.loading ? (<div className="  flex justify-center items-center">
              ...
              </div>) : (state.products.map((product, index) => {
            var _a;
            return (<div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800" key={index}>
                ...
                /> */}
                  ...
                  <div className="pt-6">
                    ...
                    <div className="mt-4 flex items-center justify-between gap-4">
                      ...
                      {state.cart.some((item) => item.id === product.id) ? (<div className="mt-1">
                          <span className="bg-red-300  px-4 py-2 rounded-s-md cursor-pointer" onClick={() => dispatch((0, ProductSlice_1.decrementQuantity)(product))}>
                            -
                          </span>
                          <span className="bg-gray-300  px-4 py-2">
                            {(_a = state.cart.find((item) => item.id === product.id)) === null || _a === void 0 ? void 0 : _a.quantity}
                          </span>
                          <span className="bg-blue-300  px-4 py-2 rounded-e-md cursor-pointer" onClick={() => dispatch((0, ProductSlice_1.incrementQuantity)(product))}>
                            +
                          </span>
                        </div>) : (<button onClick={() => {
                        dispatch((0, ProductSlice_1.addToCart)(product));
                        dispatch((0, UserSlice_1.addCart)(state.cart));
                    }} type="button" className="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white  dark:bg-blue-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
