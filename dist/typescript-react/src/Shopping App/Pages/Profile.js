      ...
      <section className="relative pt-40 pb-24 bg-gray-900">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 ">
          <div className="flex items-center justify-center sm:justify-start relative z-10 mb-5">
            <img src={(_a = user.loginUser) === null || _a === void 0 ? void 0 : _a.avatar} alt="user-avatar-image" className="border-4 border-solid border-white rounded-full object-cover h-52"/>
          </div>
          <div className="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5 ">
            <div className="block">
              <h3 className="font-manrope font-bold text-4xl text-white mb-1">
                {(_c = (_b = user.loginUser) === null || _b === void 0 ? void 0 : _b.name) === null || _c === void 0 ? void 0 : _c.toUpperCase()}
              </h3>
              <p className="font-normal text-base leading-7 text-white">
                {(_d = user.loginUser) === null || _d === void 0 ? void 0 : _d.email}
              </p>
            </div>
            <button className="rounded-full py-3.5 px-5 bg-gray-100 flex items-center group transition-all duration-500 hover:bg-indigo-100 ">
              ...
              <span className="px-2 font-medium text-base leading-7 text-gray-700 transition-all duration-500 group-hover:text-indigo-600">
                {(_e = user.loginUser) === null || _e === void 0 ? void 0 : _e.role}
              </span>
            </button>
          </div>
          <div className="flex flex-col lg:flex-row max-lg:gap-5 items-center justify-between py-0.5">
            <div className="flex items-center gap-4">
              <react_router_dom_1.Link to={`/edit/${(_f = user.loginUser) === null || _f === void 0 ? void 0 : _f.id}`} className="py-3.5 px-5 rounded-full bg-indigo-600 text-white font-semibold text-base leading-7 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-100 hover:bg-indigo-700">
                Edit Profile
              </react_router_dom_1.Link>
              <button onClick={() => dispatch((0, UserSlice_1.deleteUser)(user.loginUser))} className="py-3.5 px-5 rounded-full bg-red-700 text-white font-semibold text-base leading-7 shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100">
                delete
              </button>
            </div>
