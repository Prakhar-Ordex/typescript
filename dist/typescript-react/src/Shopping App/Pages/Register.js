...
const Register = () => {
    ...
    const { register, handleSubmit, setError, formState: { errors, isSubmitting }, reset, } = (0, react_hook_form_1.useForm)();
    const onSubmit = (data) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield dispatch((0, UserSlice_1.registerUser)(data));
            reset();
            navigate("/login");
        }
        catch (error) {
    ...
    return (<div className="py-16 bg-gray-800 min-h-screen">
      <div className="max-w-4xl mx-auto font-[sans-serif] p-6  bg-gray-100 rounded-lg shadow  mt-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            <div>
              ...
              <input type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-transparent outline-blue-500 transition-all border-2" placeholder="Enter name" {...register("name", {
        ...
        minLength: { value: 3, message: "Min lenght 3" },
            ...
            <div>
              ...
              <input type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-transparent outline-blue-500 transition-all border-2" placeholder="Enter email" {...register("email", {
        ...
        pattern: {
            ...
            <div>
              ...
              <input type="password" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-transparent outline-blue-500 transition-all border-2" placeholder="Enter password" {...register("password", {
        ...
        pattern: {
            ...
            <div>
              ...
              <input type="text" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-transparent outline-blue-500 transition-all border-2" placeholder="Enter confirm password" {...register("avatar", {
